...
const DICTIONARY: Dictionary = {
	"tr": {
		...
		"tab_lifestyle": "Mola & Yaşam",
		"tab_energy": "Yeşil Enerji & EV",
		"tab_land": "Arsa Genişletme",
		"plot_tire_shop": "Lastik Servisi & Rot-Balans",
		"plot_lube_bay": "Hızlı Yağ & Sıvı Değişim",
		"plot_vacuum_hub": "Oto Vakum & Detailing Hub",
		"plot_moto_dock": "Moto Kurye & Batarya Takas",
		"plot_truck_stop": "Ağır Vasıta / Tır Peronu",
		"plot_bakery_drive": "Drive-Thru Cafe & Bakery",
		"plot_food_truck": "Retro Burger Karavanı",
		"plot_rest_lounge": "7/24 Temiz Mola & WC",
		"plot_pet_park": "Evcil Hayvan Mola Parkı",
		"plot_parcel_hub": "Akıllı Kargo Dolabı Hub",
		"plot_atm_hub": "Zırhlı ATM & Kripto Kiosk",
		"plot_hydrogen_bay": "Yeşil Hidrojen Silosu & Peronu",
		"rush_title": "AKARYAKIT TANKERİ RUSH SAATİ!",
		"rush_sub": "Tüm tesislerde 2X Hızlı Gelir & Ücretsiz Yakıt İkmali",
		"vault_title": "Çevrimdışı Kasa Geliri",
		"vault_desc": "Siz yokken istasyon tesisleriniz çalışmaya devam etti!",
		"vault_time": "Geçen Süre:",
		"vault_collect": "KASAYA AKTAR",
		"vault_double": "2X İLE AL (BONUS)",
		"vault_cap_warning": "Kasa kapasitesi (2 Saat) doldu! Gelir kaybı yaşamamak için düzenli uğrayın.",
		"streak_title": "7 Günlük Giriş Serisi",
		"streak_subtitle": "İstasyonu her gün ziyaret et, 7. günde Mega İkramiye kazan!",
	...
	"en": {
		...
		"tab_lifestyle": "Rest & Lifestyle",
		"tab_energy": "Green Energy & EV",
		"tab_land": "Land Expansion",
		"plot_tire_shop": "Tire Shop & Alignment",
		"plot_lube_bay": "Express Lube & Oil Bay",
		"plot_vacuum_hub": "Auto Vacuum & Detailing Hub",
		"plot_moto_dock": "Courier Moto Swap Dock",
		"plot_truck_stop": "Heavy Duty Truck Stop",
		"plot_bakery_drive": "Drive-Thru Cafe & Bakery",
		"plot_food_truck": "Retro Burger Van",
		"plot_rest_lounge": "24/7 Rest Lounge & WC",
		"plot_pet_park": "Pet Rest & Play Park",
		"plot_parcel_hub": "Smart Parcel Locker Hub",
		"plot_atm_hub": "Armored ATM & Crypto Kiosk",
		"plot_hydrogen_bay": "Green H2 Hydrogen Bay",
		"rush_title": "FUEL TANKER RUSH HOUR!",
		"rush_sub": "2X Revenue Across All Facilities & Free Tank Refills",
		"vault_title": "Offline Vault Profits",
		"vault_desc": "Your station facilities kept generating revenue while you were away!",
		"vault_time": "Elapsed Time:",
		"vault_collect": "CLAIM REVENUE",
		"vault_double": "CLAIM 2X (BONUS)",
		"vault_cap_warning": "Vault cap (2 Hours) reached! Log in regularly to avoid lost revenue.",
		"streak_title": "7-Day Daily Streak",
		"streak_subtitle": "Visit your station daily and claim the Day 7 Mega Jackpot!",
